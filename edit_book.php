                  ...
                  <div class="col-md-12"> -->
                    ...
                    <div class="form-group">
                      <div class="col-sm-3">
                        ...
                        <img src="image/01/<?php echo $rowedit['b_img1']; ?>" width="80%" class="img-rounded">
                    ...
                    <div class="form-group">
                      <div class="col-sm-3">
                        ...
                        <img src="image/02/<?php echo $rowedit['b_img2']; ?>" width="80%" class="img-rounded">
                    ...
                    <div class="form-group">
                      <div class="col-sm-3">
                        ...
                        <img src="image/03/<?php echo $rowedit['b_img3']; ?>" width="80%" class="img-rounded">
                        <br><br>
                      </div>
                    </div>
