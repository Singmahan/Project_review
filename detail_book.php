    ...
    <div class="container">
      <div class="row">
        <div class="col-xs-12 col-sm-4 col-md-3">
          <img src="image/01/<?php echo $row['b_img1']; ?>" width="100%" class="img-rounded"><br><br>
          <div class="form-grup">
                ...
                <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                  ...
                  <div class="carousel-inner" role="listbox">
                    <div class="item active" align="center">
                      <img src="image/01/<?php echo $row['b_img1']; ?>" width="40%" class="img-rounded">
                    </div>
                    <div class="item" align="center">
                      <img src="image/02/<?php echo $row['b_img2']; ?>" width="40%" class="img-rounded">
                    </div>
                    <div class="item" align="center">
                      <img src="image/03/<?php echo $row['b_img3']; ?>" width="40%" class="img-rounded">
                    </div>
                  </div>
                  <!-- Controls -->
